...
import module.dend_compartment
import module.wiring as wr
...
class BaseDend(base.MemoryModule, abc.ABC):
    ...
    def __init__(
        self, compartment: module.dend_compartment.BaseDendCompartment,
...
class VDiffDend(BaseDend):
    ...
    def get_internal_input(self) -> torch.Tensor:
        ...
        input_internal = module.functional.diff_mask_mult_sum(
