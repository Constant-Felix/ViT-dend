...
from module import *
from module import soma


class SpikeDrivenTransformer_dend(nn.Module):
    def __init__(
        self,
        img_size_h=128,
        img_size_w=128,
        ...
        if integer == False:
            ...
            self.head_lif = soma.IntergerSoma(step_mode='m')
        self.head = (
...
@register_model
def dend_sdt(**kwargs):
    model = SpikeDrivenTransformer_dend(
        **kwargs,
    )
