    ...
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., sr_ratio=1,
        ...
        if dend==False:
            ...
            if multi==False:
                ...
                self.dc4 = dend_compartment.MultiScaleDendCompartment(num_compartment,step_mode='m',c_sub=dim*num_compartment)    
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, drop=0.,
        ...
        if dend==False:
            ...
            if multi==False:
                ...
                self.dc2 = dend_compartment.MultiScaleDendCompartment(num_compartment,step_mode='m',c_sub=hidden_features*num_compartment)    
            self.wr2 = wiring.SegregatedDendWiring(num_compartment)
            self.dend2 = dendrite.SegregatedDend(step_mode='m',compartment=self.dc2,wiring=self.wr2)
            if integer == False:
                self.soma2 = soma.LIFSoma(step_mode='m')
...
class spiking_transformer_dend(nn.Module):
    def __init__(self,
                 ...
                 depths=[6, 8, 6], sr_ratios=[8, 4, 2], T=4, pretrained_cfg=None,dend=False,integer=False,num_compartment=2,multi=False,sps_integer=False,bn_alter=False
                 ):
        super().__init__()
